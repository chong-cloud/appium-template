...
class MyTests(unittest.TestCase):
    ...
    def test_calculator(self, t=500, n=4):
        ...
        for i in range(6):
            print("测试是测试        ", len(self.driver.find_elements(By.CSS_SELECTOR, ".android.webkit.WebView[text='Mathbot Editor']")))
            self.driver.find_element(By.CSS_SELECTOR, ".android.webkit.WebView[text='Mathbot Editor']").click()
            time.sleep(1)
        ...
        btn_xpath = '/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.support.v4.widget.DrawerLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.LinearLayout[2]/android.widget.LinearLayout/android.widget.LinearLayout[3]/android.view.ViewGroup/android.widget.GridView/android.widget.FrameLayout[{0}]/android.widget.FrameLayout/android.widget.ImageView'
